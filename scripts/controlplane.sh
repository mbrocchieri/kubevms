...
sudo kubeadm init --apiserver-advertise-address="${IP_BASE}.10" --apiserver-cert-extra-sans="${IP_BASE}.10" --node-name controlplane --pod-network-cidr=${POD_CIRD}
#--service-cidr=${SERVICE_CIRD}
